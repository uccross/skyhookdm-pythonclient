...
setup(
  name = 'skyhookdm-pythonclient',         # How you named your package folder (MyLib)
  packages = ['skyhookdm-pythonclient'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/uccross/skyhookdm-pythonclient/archive/v0.1.tar.gz',    # I explain this later on
